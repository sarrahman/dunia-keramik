    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static">
        <Toolbar sx={{
          ...
          <CardMedia sx={{ cursor: 'pointer', width: 160 }} component="img" onClick={() => navigate('/')} src="https://ik.imagekit.io/duniakeramik/Dunia_Keramik__2_-removebg-preview_TJiuJARjl.png" alt="logo" />
